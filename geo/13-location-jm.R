...
p_1 = spplot(input_ras, col.regions = RColorBrewer::brewer.pal(6, "GnBu"), 
             ...
             sp.layout = list(
               list("sp.polygons", ger, col = gray(0.5),
                    first = FALSE)))
# save the output
ggplot2::ggsave(filename = "./geo/figures/08_census_stack.png",
...
# save the output
ggplot2::ggsave(filename = "./geo/figures/08_metro_areas.png",
...
mapshot(m, url = file.path(getwd(), "./geo/figures/08_bikeshops_berlin.html"))
